...
from blog.models import CreateUpdateMixin
...
class Slider(CreateUpdateMixin):
...
class BannerSite(CreateUpdateMixin):
...
class CommentProduct(CreateUpdateMixin):
